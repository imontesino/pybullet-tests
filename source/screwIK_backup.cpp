...
VectorXd rl_from_foot(Matrix4d noap){
    VectorXd solution(6);
...
VectorXd ll_from_foot(Matrix4d noap){
    VectorXd solution(6);
    ...
    if(theta12and11(0)>-0.7417649321 && theta12and11(0)<0.3473205211){
        ...
        //           7    8    9      10    11   12
        solution << NAN, NAN, NAN, theta10, NAN, NAN;
        return solution;
    }
    ...
    if(theta9and8(0)>-0.5515240436 && theta9and8(0)<0.7382742736){
        ...
        //           7    8    9      10      11        12
        solution << NAN, NAN, NAN, theta10, theta11, theta12;
        return solution;
    }
    ...
    if(theta7>-0.4869468613 && theta7<0.5724679947){
        solution << theta7, theta8, theta9, theta10, theta11, theta12;
        return solution;
    }else{
             //      7      8       9       10      11        12
        solution << NAN, theta8, theta9, theta10, theta11, theta12;
        return solution;
    }
}
...
PYBIND11_MODULE(screwIK, m) {
    ...
    m.def("rl_from_foot", &rl_from_foot, "Inverse kinematics solution from the right foot to the hip");
    m.def("ll_from_foot", &ll_from_foot, "Inverse kinematics solution from the left foot to the hip");
}
