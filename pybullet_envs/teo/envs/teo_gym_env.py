"""This file implements the gym environment of TEO.
...
class MinitaurGymEnv(gym.Env):
  """The gym environment for TEO.

  It simulates the locomotion of TEO, the humanoid of the University Calros II of Madrid. The state
  space include the angles, velocities and torques for all the motors and the action
  space is the desired motor angle for each motor. The reward function is based
  on how far the TEO walks in 1000 steps and penalizes the energy
  expenditure.

  This is a modification of the minitaur gym env

  """
  metadata = {"render.modes": ["human", "rgb_array"], "video.frames_per_second": 100}

  def __init__(self,
               urdf_root=os.path.join(parentdir,"teo/urdf"),
               distance_weight=1.0,
               energy_weight=0.005,
               shake_weight=0.0,
               drift_weight=0.0,
